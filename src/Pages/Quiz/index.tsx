                        ...
                        <div id="flush-collapseOne" className="accordion-collapse collapse"
                            ...
                            <ul className="list-group list-group-flush accordion-body">
                                <li className="list-group-item">
                                    <a href="#" className="questions" id="q0-0">Há quanto tempo está assim?</a>
                                </li>
                                <li className="list-group-item">
                                    <a href="#" className="questions" id="q0-1">Como você me descreveria essa dor: Em peso,
                                        pontada, aperto, latejante ou queimação? </a>
                                </li>
                                <li className="list-group-item">
                                    <a href="#" className="questions" id="q0-2">É uma dor constante ou que varia durante o
                                        dia?</a>
                                </li>
                                <li className="list-group-item">
                                    <a href="#" className="questions" id="q0-3">Se você pudesse dar uma nota para essa dor
                                        de 0 a 10, sendo 0 nada de 10 a pior dor da sua vida, quanto você daria?</a>
                                </li>
                                <li className="list-group-item">
                                    <a href="#" className="questions" id="q0-4">Teve febre ou calafrios nesse período?</a>
                                </li>
                                <li className="list-group-item">
                                    <a href="#" className="questions" id="q0-5">Teve outros sintomas associados?</a>
                                </li>
                                <li className="list-group-item">
                                    <a href="#" className="questions" id="q0-6">Tomou alguma medicação em casa?</a>
                                </li>
